...
// import 'package:newsapp/Featuers/home/user_info/persentation/views/show_snck_bar.dart';
...
class _UserInfoViewBodyState extends State<UserInfoViewBody> {
  ...
  Future<void> stroeData() async {
    if (image != null) {
      ...
      // Handle case where image is null, maybe show an error or use a default image
